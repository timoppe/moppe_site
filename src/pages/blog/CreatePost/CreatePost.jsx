      ...
      uploadTask.on(
        ...
        async () => {
          try {
            ...
            try {
              const response = await fetch("http://localhost:3001/blog/createpost", {
                method: "POST",
                headers: {
              ...
              if (response.ok) {
                ...
                navigate("/blog"); // Redirecione para a página desejada após o sucesso
              } else {
                // A solicitação falhou; lida com erros
