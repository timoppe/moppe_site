            ...
            <div className={styles.container}>
                <div className={styles.flex}>
                    ...
                    <div className={styles.contato}>
                        <li><NavLink to="https://escolamoppe.chat.blip.ai/?appKey=bW9wcGU6MzFlODA5YzYtMDQzOS00NGQ1LTk1YzctNWFmOTAwMjZlMDQ2" target="_blank"><button>AGENDE SUA VISITA</button></NavLink></li>
                    </div>
                </div>
            </div>
        </header>
